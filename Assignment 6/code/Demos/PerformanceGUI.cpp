...
namespace {
    ...
    PerformanceGUI::PerformanceGUI(GWindow& window) : ProblemHandler(window) {
        heapPQ  = make_temporary<GButton>(window, "SOUTH", "Heap Priority Queue");
        topK    = make_temporary<GButton>(window, "SOUTH", "Streaming Top-K");
